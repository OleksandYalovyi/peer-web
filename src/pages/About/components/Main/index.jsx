      ...
      <div className={styles.row}>
        ...
        <div className={classNames(styles.col, styles.fixed)}>
          <h3>
            ...
            strategists, designers, and builders—all committed to building and democratizing access
            to the next generation of innovation for billions of people.
          </h3>
      ...
      <div className={styles.row}>
        <div className={styles.col}>
          ...
          <p>
            ...
            , which has been downloaded 160 million times worldwide and boasts 45 million daily
            active users. In addition, some of us have worked on globally recognized hardware
